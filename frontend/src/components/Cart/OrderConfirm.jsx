...
/*
Displays the order confirmation step in checkout flow.

Fetches cart items and user data from Redux.

Shows products in read-only mode.

Indicates progress using a Stepper component.

Displays the email for order confirmation.

Navigates user to the payment page on continue.

Shows price summary alongside items.
