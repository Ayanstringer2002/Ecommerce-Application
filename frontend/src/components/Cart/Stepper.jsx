...
The Stepper component visually represents a multi-step checkout flow (Login → Address → Order Summary → Payment).
It dynamically updates step status using Redux state, highlights the current step,
and shows completed steps with check icons.
*/

/*

The Stepper component manages the visual flow of a multi-step checkout process. 
It dynamically renders active, completed, and upcoming steps based on the current step index and Redux state. 
The component enhances user experience by showing progress, completed step summaries, 
and context-aware content through reusable step components.
