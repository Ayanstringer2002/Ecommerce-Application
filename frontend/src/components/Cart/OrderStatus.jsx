...
Fetches payment status using transaction ID.

If payment is successful, creates a new order.

If payment fails, redirects to failure page.
...
Shows a loader while processing.
