...
/*
The Shipping component manages the shipping address step in an e-commerce checkout flow.
 It pre-fills user data from Redux, validates critical fields such as phone number, and saves shipping information back to the global store. 
 The component leverages Material UI for form elements, Notistack for user feedback, 
and React Router for seamless navigation, while maintaining a responsive layout with a live price summary.
