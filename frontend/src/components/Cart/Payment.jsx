...
Receives Paytm payment parameters.

Redirects user to Paytm payment gateway.

Disables pay button during processing.

Handles and displays payment/order errors.

Shows checkout progress and price summary.

Interview One-liner

“This component handles the payment step by initiating Paytm payment, 
redirecting the user to the gateway, and managing loading and error states.”
