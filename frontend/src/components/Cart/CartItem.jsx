...
Short & Crisp Summary Logic

Displays a single cart item with product details and pricing.

Allows users to increase/decrease quantity with stock validation.

Prevents invalid quantities (less than 1 or more than stock).

Enables removing items from cart.

Allows saving items for later, moving them out of the cart.

Uses Redux for state updates and snackbars for user feedback.

Clicking the item navigates to the product details page.
