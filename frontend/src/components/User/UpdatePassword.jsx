...
The UpdatePassword component allows a logged-in user to securely change their current password from their account section. 
It validates inputs, updates the password via Redux actions, and refreshes user data after success.
...
The UpdatePassword component enables authenticated users to securely change their account password.

It validates user inputs, updates the password via Redux actions, reloads user data on success, 
and provides real-time feedback through notifications.
