...
The Sidebar component renders the user account navigation panel (similar to Ecommerce app profile sidebar). 
It displays user information, account-related links, wishlist, orders, and provides a logout functionality.
...
Profile info (active highlighting)
...
Wishlist (active tab supported)

Logout

Clickable logout option

Triggers Redux logout flow
...
The Sidebar component displays user profile details and account navigation options.

It fetches user data from Redux, highlights the active menu item, and enables secure logout functionality.

The component improves user experience by organizing account features into clear, accessible sections.
