...
The UpdateProfile component allows an authenticated user to update their personal details such as name, email, gender, and avatar image. 
It uses Redux for state management, Material UI for form inputs, and provides real-time feedback through notifications.
...
The UpdateProfile component enables users to update personal information including name, email, gender,
 and profile picture.

It pre-fills existing user data, supports image preview, manages async updates using Redux,
 and provides feedback via notifications and loaders.
