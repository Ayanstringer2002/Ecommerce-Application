...
OrderDetails fetches and displays details of a specific order using the order ID from the URL.

Redux manages order state, loading, and errors.

Errors are shown using snackbars and cleared after display.

The UI shows delivery details, ordered items, and real-time order status tracking.

Conditional rendering ensures smooth UX with loading states and valid data checks.
