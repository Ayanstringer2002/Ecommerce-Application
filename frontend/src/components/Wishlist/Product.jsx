...
The Product component displays a single product item inside the Wishlist page.
It shows product details such as image, name, ratings, reviews, price, discount, 
and allows the user to remove the product from the wishlist.

*/

/*

The Product component renders a wishlist product item displaying its image, name, ratings, pricing details, and discount. 
It allows users to navigate to the product page and remove the item from the wishlist using Redux actions.
