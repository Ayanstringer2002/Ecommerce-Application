...
What This Component Does (Overview)

Products renders the main product listing page of the e-commerce app.
It supports:
...
Responsive layout with a filter sidebar

It integrates Redux, React Router, Material UI, and Notistack.
...
The Products component displays a paginated list of products.

Users can filter products by price range, category, and ratings.

Filters and pagination dynamically trigger API calls via Redux.

Loading, error, and empty states are handled gracefully.

The UI is responsive with a collapsible filter sidebar and reusable product cards.
