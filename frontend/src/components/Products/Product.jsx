...
The Product component displays an individual product card with image, rating, price, and discount.

It checks whether the product exists in the user’s wishlist using Redux state.

Users can add or remove products from the wishlist via a toggle icon.

Wishlist actions dispatch Redux events and show feedback using snackbars.

Clicking the product navigates to the product detail page.
