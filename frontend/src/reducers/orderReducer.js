...
This file contains multiple Redux reducers, 
each responsible for managing a specific part of the order lifecycle in an e-commerce application.
*/

/*

These Redux reducers collectively manage the complete order lifecycle in an e-commerce application, 
including order creation, fetching user and admin orders, tracking payment status, 
retrieving order details, and handling order updates or deletions with proper loading and error management.
*/