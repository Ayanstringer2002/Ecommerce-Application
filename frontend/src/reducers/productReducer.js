...
This file contains multiple Redux reducers that manage product-related state in an e-commerce application, 
including product listing, product details, reviews, and admin product operations.

*/

/*

Logical Summary (Short & Interview-Ready)

These Redux reducers collectively manage all product-related functionality in the application, 
including product listings, product details, reviews, and admin operations like product creation, updates, deletions, 
and review moderation, while maintaining consistent loading, success, reset, and error states.
